...
variable "codepipeline_s3_bucket" {
  description = "The aws_s3_bucket name for codepipeline_s3_bucket"
  type        = string
  default     = "saeed-codepipeline-bucket-new"
}

variable "codepipeline" {
  description = "The aws_codepipeline name for codepipeline"
  type        = string
  default     = "saeed-pipeline"
}

variable "codepipeline_role" {
  description = "The aws_iam_role name for codepipeline_role"
  type        = string
  default     = "saeed-pipeline-role"
}
